...
/***************************************************************************************
** Function name:           fillCircleHelper
** Description:             Support function for fillRoundBorder()
***************************************************************************************/
// Support drawing roundrects, changed to horizontal lines (faster in sprites)
void TFT_eSPI::fillCircleHelper(int32_t x0, int32_t y0, int32_t d, int32_t r, uint8_t cornername, int32_t delta, uint32_t color)
{
  int32_t f     = 1 - r;
  int32_t ddF_x = 1;
  int32_t ddF_y = -r - r;
  ...
  while (y < r) {
    if (f >= 0) {
      if (cornername & 0x1) { if(true || r>rd) drawFastHLine(x0 - y, y0 + r, y + y + delta, color); else { drawFastHLine(x0 - y, y0 + r, y-last, color); drawFastHLine(x0 + delta -last+y, y0 + r, y-last, color); } }
      if (cornername & 0x2) { if(true || r>rd) drawFastHLine(x0 - y, y0 - r, y + y + delta, color); else { drawFastHLine(x0 - y, y0 - r, y-last, color); drawFastHLine(x0 + delta -last +y, y0 - r, y-last, color); } }
      r--;
      ddF_y += 2;
      f     += ddF_y;
      last = y;
    ...
    if (cornername & 0x1) { if(y>rd) drawFastHLine(x0 - r, y0 + y, r + r + delta, color); else {drawFastHLine(x0 - r, y0 + y, r>d&&false?d:r, color); drawFastHLine(x0 + delta + (r>d&&false?r-d:0), y0 + y, r>d&&false?d:r, color); } }
    if (cornername & 0x2) { if(y>rd) drawFastHLine(x0 - r, y0 - y, r + r + delta, color); else {drawFastHLine(x0 - r, y0 - y, r>d&&false?d:r, color); drawFastHLine(x0 + delta + (r>d&&false?r-d:0), y0 - y, r>d&&false?d:r, color); } }
  }
}
...
** Description:             Draw a hollow border
***************************************************************************************/
// Fill a rounded rectangle, changed to horizontal lines (faster in sprites)
void TFT_eSPI::drawBorder(int32_t x, int32_t y, int32_t w, int32_t h, int32_t d, uint32_t color)
{

  drawRect(x, y, w, h, color);
  d--;
  drawRect(x+d, y+d, w-2*d, h-2*d, color);
...
/***************************************************************************************
** Function name:           fillRoundRect
** Description:             Draw a filled border
***************************************************************************************/
// Fill a rounded rectangle, changed to horizontal lines (faster in sprites)
void TFT_eSPI::fillBorder(int32_t x, int32_t y, int32_t w, int32_t h, int32_t d, uint32_t color)
{
...
/***************************************************************************************
** Function name:           fillRoundRect
** Description:             Draw a rounded corner hollow border
***************************************************************************************/
// Fill a rounded rectangle, changed to horizontal lines (faster in sprites)
void TFT_eSPI::drawRoundBorder(int32_t x, int32_t y, int32_t w, int32_t h, int32_t d, int32_t r, uint32_t color)
{

  drawRoundRect(x, y, w, h, r, color);
  d--;
  drawRoundRect(x+d, y+d, w-2*d, h-2*d, r, color);
...
/***************************************************************************************
** Function name:           fillRoundRect
** Description:             Draw a rounded corner filled border
***************************************************************************************/
// Fill a rounded rectangle, changed to horizontal lines (faster in sprites)
void TFT_eSPI::fillRoundBorder(int32_t x, int32_t y, int32_t w, int32_t h, int32_t d, int32_t r, uint32_t color)
{

  // smarter version
  fillRect(x, y + r, d, h - r - r, color);
  fillRect(x + w - d, y + r, d, h - r - r, color);

  if(d>r) {
     fillRect(x+r, y+r, w - 2*r, d-r, color); 
     fillRect(x+r, y+h-d, w - 2*r, d-r, color); 
  }
  ...
  // draw four corners
  fillCircleHelper(x + r, y + h - r - 1, d, r, 1, w - r - r - 1, color);
  fillCircleHelper(x + r, y + r, d, r, 2, w - r - r - 1, color);
