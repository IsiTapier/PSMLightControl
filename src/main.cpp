...
MovingHead movingHead1(HEIGHT_MV1, X_OFFSET_MV1, Y_OFFSET, TILT_OFFSET_MV1, PAN_OFFSET_MV1, UNIVERSE_3, 1,  INPUT_UNIVERSE, INPUT_ADDRESS, X_DEFAULT_MV1);
MovingHead movingHead2(HEIGHT_MV2, X_OFFSET_MV2, Y_OFFSET, TILT_OFFSET_MV2, PAN_OFFSET_MV2, UNIVERSE_3, 14, INPUT_UNIVERSE, INPUT_ADDRESS, X_DEFAULT_MV2);
MovingHead movingHead3(HEIGHT_MV3, X_OFFSET_MV3, Y_OFFSET, TILT_OFFSET_MV3, PAN_OFFSET_MV3, UNIVERSE_3, 27, INPUT_UNIVERSE, INPUT_ADDRESS, X_DEFAULT_MV3);
MovingHead movingHead4(HEIGHT_MV4, X_OFFSET_MV4, Y_OFFSET, TILT_OFFSET_MV4, PAN_OFFSET_MV4, UNIVERSE_3, 40, INPUT_UNIVERSE, INPUT_ADDRESS, X_DEFAULT_MV4);
MovingHead movingHead5(HEIGHT_MV5, X_OFFSET_MV5, Y_OFFSET, TILT_OFFSET_MV5, PAN_OFFSET_MV5, UNIVERSE_3, 53, INPUT_UNIVERSE, INPUT_ADDRESS, X_DEFAULT_MV5);
MovingHead movingHead6(HEIGHT_MV6, X_OFFSET_MV6, Y_OFFSET, TILT_OFFSET_MV6, PAN_OFFSET_MV6, UNIVERSE_3, 66, INPUT_UNIVERSE, INPUT_ADDRESS, X_DEFAULT_MV6);
